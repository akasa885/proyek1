...
@section('judul_header','Halaman Pengaturan Petunjuk Pengaduan')
  ...
  <div class="main-card mb-3 card">
    <div class="card-body">
      ...
      <div class="d-block text-center card-footer">
        <button id="hint-input-add" target="1" class="btn-wide btn btn-info" type="button" name="button">Simpan</button>
      </div>
    </div>
  </div>
</div>
