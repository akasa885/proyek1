...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Dashboard Admin BNNK Sidoarjo</title>
  </head>
  <body>
                              ...
                              <div class="widget-content-left">
                                  <div class="btn-group">
                                      ...
                                      <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                          <button type="button" tabindex="0" class="dropdown-item" disabled>{{$username}}</button>
                                          <div tabindex="-1" class="dropdown-divider"></div>
                                          <button type="button" tabindex="0" class="dropdown-item" id="logout_button">Logout</button>
                                      </div>
                                  </div>
                              </div>
      ...
      <div class="ui-theme-settings">
            ...
            <div class="theme-settings__inner">
                ...
                <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 635px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 374px;"></div></div></div>
            </div>
        </div>
          <div class="app-main">
                ...
                <div class="app-header__menu">
                    ...
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                <a href="/dpanel" class="mm-active">
                                    <i class="metismenu-icon pe-7s-rocket"></i>
                                    Dashboard BNNK
                                </a>
                            </li>
                            @if($integritas == 'admin' || $integritas == 'Super Admin')
                            <li class="app-sidebar__heading">Master</li>
                            <li>
                                <a href="/dpanel/user-setting">
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="/dpanel/form/agama">
                                            <i class="metismenu-icon"></i>
                                            Agama
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/dpanel/form/job">
                                            <i class="metismenu-icon"></i>
                                            Pekerjaan
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/dpanel/form/narkoba">
                                            <i class="metismenu-icon"></i>
                                            Narkoba
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/dpanel/form/suku">
                                            <i class="metismenu-icon"></i>
                                            Suku
                                        </a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="/dpanel/hint/setting/1">
                                            <i class="metismenu-icon">
                                            </i>Pengaduan
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/dpanel/hint/setting/2">
                                            <i class="metismenu-icon">
                                            </i>Sosialisasi
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/dpanel/hint/setting/3">
                                            <i class="metismenu-icon">
                                            </i>Rehabilitasi
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/dpanel/hint/setting/4">
                                            <i class="metismenu-icon">
                                            </i>SKHPN
                                        </a>
                                    </li>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" id="user-in-delete">Delete</button>
            </div>
        </div>
    </div>
</div>
