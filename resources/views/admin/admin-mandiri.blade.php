...
@section('judul_header','Halaman Daftar Urine Mandiri')
@section('sub_header','Ini adalah halaman Tes Urine BNNK Sidoarjo')
@section('icon_title')
          ...
          <div class="col-md-4">
              ...
              <div class="form-group">
                ...
                <div class="form-inline">
                  ...
                  <button type="button" class="btn btn-info" id="cari_for_form" name="button" target="5">Cari</button>
                </div>
              </div>
          </div>
          <div class="col-md-4">
            ...
            <tr>
              ...
              <td><button type="button" aria-haspopup="true" aria-expanded="false" data-toggle="dropdown" class="mb-2 mr-2 dropdown-toggle btn btn-outline-info">Action</button>
                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu">
                  ...
                  <button type="button" tabindex="0" class="dropdown-item" id="view_mandiri" onclick="lihat_mandiri('{{$row->kode_registrasi}}')">Edit</button>
                  <div id="del_button_user">
                    <button type="button" tabindex="0" class="dropdown-item" name="button{{ $row->id }}" value="10">Delete</button>
                  </div>
                </div>
              </td>
            </tr>
